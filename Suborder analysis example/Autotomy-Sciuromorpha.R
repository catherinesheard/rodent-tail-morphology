...
x<-x[which(x$Suborder=="Sciuromorpha"),]
...
save(Final.mod,file="autonomy-S.Rdata")
...
for(i in 1:100){ #loop through 100 trees
  ...
  save(Final.mod,file="autonomy-S.Rdata") #this will slow down your model; you can turn it off
