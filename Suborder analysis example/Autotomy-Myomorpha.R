...
x<-x[which(x$Suborder=="Myomorpha"),]
...
save(Final.mod,file="autonomy-M.Rdata")
...
for(i in 1:100){ #loop through 100 trees
  ...
  save(Final.mod,file="autonomy-M.Rdata") #this will slow down your model; you can turn it off
